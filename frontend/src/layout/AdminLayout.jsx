...
function AdminLayout({ children }) {
  ...
  const dashboardPath = isSuperAdmin ? '/admin' : '/admin/dashboard'
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between h-16 px-4 border-b border-gray-200 dark:border-gray-800">
            {(isDesktop && (isExpanded || (isHovered && !isExpanded))) || (!isDesktop && isMobileOpen) ? (
              <Link 
                to={isSuperAdmin ? '/admin' : '/admin/dashboard'} 
              ...
              >
                <img
                  ...
                  className="w-6 h-6"
                />
                <span>{isSuperAdmin ? 'Fincy Admin' : 'Fincy Educator'}</span>
              </Link>
            ) : (
              <img
                src="/logo-fincy-web.svg"
          ...
          {/* User Guide */}
          {((isDesktop && (isExpanded || (isHovered && !isExpanded))) || (!isDesktop && isMobileOpen)) && (
            <UserGuide type={isSuperAdmin ? 'admin' : 'educator'} />
          )}
        </div>
      </aside>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="hidden md:block">
                <h2 className="text-lg font-semibold text-gray-800 dark:text-white/90">
                  ...
                  {location.pathname === '/admin/ratings' && 'Ratings & Reviews'}
