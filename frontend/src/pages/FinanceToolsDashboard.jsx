  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Total Income */}
        <div className="group relative bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden">
          ...
          <div className="relative">
            <div className="flex items-center justify-between mb-4">
              ...
              <Badge color="success" variant="light" className="text-xs">Income</Badge>
            </div>
        ...
        {/* Total Expense */}
        <div className="group relative bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden">
          <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-red-100/50 to-transparent dark:from-red-900/20 rounded-full -mr-16 -mt-16 opacity-50 group-hover:opacity-75 transition-opacity blur-2xl"></div>
          <div className="relative">
            <div className="flex items-center justify-between mb-4">
              ...
              <Badge color="error" variant="light" className="text-xs">Expense</Badge>
            </div>
            <h3 className="text-3xl font-bold text-gray-900 dark:text-white mb-1">
        ...
        {/* Balance Card */}
        <div className={`group relative bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden ${
          isPositive 
            ? 'border-purple-200 dark:border-purple-800' 
            : 'border-red-200 dark:border-red-800'
        }`}>
          <div className={`absolute top-0 right-0 w-32 h-32 rounded-full -mr-16 -mt-16 opacity-50 group-hover:opacity-75 transition-opacity blur-2xl ${
            isPositive
              ? 'bg-gradient-to-br from-purple-100/50 to-transparent dark:from-purple-900/20'
              : 'bg-gradient-to-br from-red-100/50 to-transparent dark:from-red-900/20'
          }`}></div>
          <div className="relative">
            <div className="flex items-center justify-between mb-4">
              ...
              <Badge color={isPositive ? 'success' : 'error'} variant="light" className="text-xs">Balance</Badge>
            </div>
            ...
            {previousMonthData && (() => {
              const trend = calculateTrend(balance, previousMonthData.balance)
              return (
                <div className={`mt-4 flex items-center text-xs ${
                  trend.isNeutral 
                    ? 'text-gray-500 dark:text-gray-400' 
                  ...
                  {trend.isNeutral ? (
                    ...
                    <>
                      ...
                      {trend.percentage.toFixed(1)}% improvement from last month
                    </>
                  ) : (
                    <>
                      <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      {trend.percentage.toFixed(1)}% decrease from last month
                    </>
                  )}
                </div>
              )
